...
class TStepMotor
{
    private:
        ...
        TParameterTMI<TypeOfX, TypeOfY> ControlImpulse; //сигнал управления обмотками ШМ
        TParameterTMI<TypeOfX, TypeOfY> POS;            //модель потенциометра обратной связи
    ...
    public:
        ...
        bool LoadParameter(TParameterTMI<TypeOfX, TypeOfY> ParameterUI, double Delta_U,               //Параметры моделирования
        ...
        bool GetPOS(TParameterTMI<TypeOfX, TypeOfY> &POS, TypeOfY TimeShift, bool FlagUsage,
                    ...
                    TIntervalCharacteristics* &LongestIntervalWithoutImpulses);       //Моделирование ПОС
...
TStepMotor<TypeOfX, TypeOfY> ::TStepMotor()
{
    ...
    Errors.SetErrorMessage(4, "Некорректный частота.");
...
template <class TypeOfX, class TypeOfY>
bool TStepMotor<TypeOfX, TypeOfY>::LoadParameter(TParameterTMI<TypeOfX, TypeOfY> ParameterUI, double Delta_U,               //Параметры моделирования
                                                double Start_U, TControlImpulse ControlLevels, double Point_Freq,
                                                double Luft, double CurrentLuftPosition)
{
